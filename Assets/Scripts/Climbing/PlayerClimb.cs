...
public class PlayerClimb : MonoBehaviour
{
    ...
    private void Inputs()
    {
        if (Input.GetKeyDown(KeyCode.C)) // Pressing Button and roof ledge is not detected
        {
    ...
    {
        if(!isClimbing && thirdPersonController.Controller.isGrounded) // if player is not climbing and player is on the ground
        {
